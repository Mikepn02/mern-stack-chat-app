...
const Navbar = () => {
    ...
    const fullName = user ? `${user.firstName} ${user.lastName}` : "Peter Mike";
    return (
        <FlexBetween padding="1rem 6%" backgroundColor={alt}>
            <FlexBetween gap="1.75rem">
                ...
                {isNonMobileScreen && (
                    <FlexBetween backgroundColor={neutralLight} borderRadius="9px" gap="3rem" padding="0.1rem 1.5rem">
                        <InputBase placeholder="Find your friend" />
                        <IconButton>
                            <Search />
            ...
            {isNonMobileScreen ? (
                <FlexBetween gap="2rem">
                    <IconButton onClick={() => dispacth(setMode())}>
                    ...
                    <FormControl variant="standard" value={fullName}>
                        ...
                        >
                            ...
                            <MenuItem onClick={() => dispacth(setLogout())}>
                                Log out
                            </MenuItem>
                        </Select>
                    </FormControl>
